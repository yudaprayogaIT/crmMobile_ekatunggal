...
class DNFormScreen extends StatelessWidget {
  String id;
  DNFormScreen({super.key, required this.id});
    ...
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: BlocBuilder<DnBloc, DnState>(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        IconButton(
                          onPressed: () {
                            BlocProvider.of<DnBloc>(context).add(
                              GetDnShow(id: id),
                            );
                          },
                          icon: const Icon(
        ...
        body: BlocBuilder<DnBloc, DnState>(
          builder: (context, state) {
            if (state is DnIsLoading) {
              return const Center(
