...
import 'package:salesappnew/screens/dn/widgets/dn_screen_body.dart';

import 'package:salesappnew/widgets/back_button_custom.dart';
import 'package:sliding_up_panel/sliding_up_panel.dart';

class DnScreen extends StatefulWidget {
  const DnScreen({super.key});

  @override
  State<DnScreen> createState() => _DnScreen();
}

class _DnScreen extends State<DnScreen> {
  List<Tab> myTabs = <Tab>[
    const Tab(
      child: Text(
        "ACTIVE",
