...
class ItemScreenBody extends StatefulWidget {
  ...
  @override
  State<ItemScreenBody> createState() => __ItemScreenBodyStateState();
}

class __ItemScreenBodyStateState extends State<ItemScreenBody> {
  ...
  void _onSearchTextChanged(String searchText) {
    bloc.add(ItemChangeSearch(searchText));
                                        ...
                                        return ListTile(
                                          ...
                                          leading: CircleAvatar(
                                            ...
                                            child: state.data[index]['image'] ==
                                                ...
                                                : ClipOval(
                                                    child: Image.network(
                                                      'http://${state.erpUri}${state.data[index]['image']}',
                                                      width: 100,
                                                      height: 100,
                                                    ),
                                                  ),
